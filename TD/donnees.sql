...
insert into FILM values (  2 , 'CESAR ET ROSALIE'             , '02/04/1971' ,  90 , 'COMEDIE'            ,  1 ) ;
insert into FILM values (  3 , 'LA FAC'                       , '24/02/1989' , 420 , 'SATYRIQUE'          ,  3 ) ;
insert into FILM values (  4 , 'LA PISCINE'                   , '13/05/1967' , 120 , 'COMEDIE DRAMATIQUE' ,  2 ) ;
...
insert into ACTEUR values (  1 , 'MONTAND'   , 'YVES'        , 'FRANCAISE'    , '13/10/1921' ) ;
insert into ACTEUR values (  2 , 'GARCIA'    , 'NICOLE'      , 'FRANCAISE'    , '21/02/1957' ) ;
insert into ACTEUR values (  3 , 'VILLERET'  , 'JACQUES'     , 'FRANCAISE'    , '06/02/1951' ) ;
insert into ACTEUR values (  4 , 'DUBOIS'    , 'MARIE'       , 'FRANCAISE'    , '12/02/1937' ) ;
insert into ACTEUR values (  5 , 'SCHNEIDER' , 'ROMY'        , 'AUTRICHIENNE' , '01/04/1942' ) ;
insert into ACTEUR values (  6 , 'FREY'      , 'SAMY'        , 'FRANCAISE'    , '24/05/1940' ) ;
insert into ACTEUR values (  7 , 'RICARDO'   , 'BRUNOZZI'    , 'ITALIENNE'    , '08/04/1958' ) ;
insert into ACTEUR values (  8 , 'DUPRILLOT' , 'JOHEL'       , 'TCHEQUE'      , '24/04/1968' ) ;
insert into ACTEUR values (  9 , 'LESTRADOS' , 'DOMINIQUOS'  , 'MEXICAINE'    , '19/02/1969' ) ;
insert into ACTEUR values ( 10 , 'DELON'     , 'ALAIN'       , 'FRANCAISE'    , '04/10/1933' ) ;
...
insert into ACTEUR values ( 18 , 'MANESSE'   , 'GASPARD'     , 'ALLEMANDE'    , '1/11/1931' ) ;
insert into ACTEUR values ( 19 , 'BELLI'     , 'AGOSTINA'    , 'FRANCAISE'    , '21/1/1941' ) ;
insert into ACTEUR values ( 20 , 'BRASSEUR'  , 'CLAUDE'      , 'FRANCAISE'    , '31/1/1951' ) ;
...
insert into ACTEUR values ( 27 , 'DE FUNES'  , 'LOUIS'       , 'FRANCAISE'    , '10/1/1901' ) ;
insert into ACTEUR values ( 28 , 'LANGLET'   , 'AMANDA'      , 'FRANCAISE'    , '1/11/1921' ) ;
