...
insert into FILM values (  2 , 'CESAR ET ROSALIE'             , '2/4/1971' ,  90 , 'COMEDIE'            ,  1 ) ;
insert into FILM values (  3 , 'LA FAC'                       , '24/2/1989' , 420 , 'SATYRIQUE'          ,  3 ) ;
insert into FILM values (  4 , 'LA PISCINE'                   , '13/5/1967' , 120 , 'COMEDIE DRAMATIQUE' ,  2 ) ;
...
insert into ACTEUR values (  2 , 'GARCIA'    , 'NICOLE'      , 'FRANCAISE'    , '21/2/1957' ) ;
insert into ACTEUR values (  3 , 'VILLERET'  , 'JACQUES'     , 'FRANCAISE'    , '6/2/1951' ) ;
insert into ACTEUR values (  4 , 'DUBOIS'    , 'MARIE'       , 'FRANCAISE'    , '12/2/1937' ) ;
insert into ACTEUR values (  5 , 'SCHNEIDER' , 'ROMY'        , 'AUTRICHIENNE' , '1/4/1942' ) ;
insert into ACTEUR values (  6 , 'FREY'      , 'SAMY'        , 'FRANCAISE'    , '24/5/1940' ) ;
insert into ACTEUR values (  7 , 'RICARDO'   , 'BRUNOZZI'    , 'ITALIENNE'    , '8/4/1958' ) ;
insert into ACTEUR values (  8 , 'DUPRILLOT' , 'JOHEL'       , 'TCHEQUE'      , '24/4/1968' ) ;
insert into ACTEUR values (  9 , 'LESTRADOS' , 'DOMINIQUOS'  , 'MEXICAINE'    , '19/2/1969' ) ;
insert into ACTEUR values ( 10 , 'DELON'     , 'ALAIN'       , 'FRANCAISE'    , '4/10/1933' ) ;
